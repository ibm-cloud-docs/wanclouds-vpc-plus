...
## Step 3. Create an instance of Custom Migration DR and Management as a Service through the {{site.data.keyword.cloud_notm}} Catalog
{: #step-3-create}

Complete the following steps to create an instance.

1. Login to your {{site.data.keyword.cloud_notm}} account.
2. Navigate to the [{{site.data.keyword.cloud_notm}} catalog](https://cloud.ibm.com/catalog).
3. In the search bar, type "Custom Migration DR and Management as a Service" and select the tile from the search results.
4. Select **Custom Migration Request** as the pricing plan.
5. Click "Create" to create the service instance.
6. Once the instance is created, you will be redirected to a [form](https://migration.wanclouds.net/?state=abcdefghij&code=fAQjJUXnQ2k). Fill out the required details and submit the form.
